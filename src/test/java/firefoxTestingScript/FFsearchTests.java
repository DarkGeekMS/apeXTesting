...
public class FFsearchTests {
	...
	public void Test1() throws Throwable {
	   ...
	   Thread.sleep(5000);
	   try {
		   SearchPage.searchTXT = FFD.LocateById(SearchPage.searchTXTid);
	   }catch(Exception e) {
	   ...
	   act = builder.sendKeys(SearchPage.searchTXT,"1111").build();
		...
		SearchPage.searchTXT.sendKeys(Keys.ENTER);		//search done about something
		 ...
		 try {
			   SearchPage.errormsg1 = FFD.LocateById(SearchPage.errormsg1id);
		   }catch(Exception e) {
    ...
    try {
    	SearchPage.postsBTN = FFD.LocateById(SearchPage.postsBTNid);
   }catch(Exception e) {
    ...
    act.perform();
    try {
    	SearchPage.post1 = FFD.LocateById(SearchPage.post1id);
   }catch(Exception e) {
    ...
    try {
    	SearchPage.UsersBTN = FFD.LocateById(SearchPage.UsersBTNid);
   }catch(Exception e) {
    ...
    act.perform();
    try {
    	SearchPage.user1 = FFD.LocateById(SearchPage.user1id);
   }catch(Exception e) {
    ...
    act.perform();
    try {
		   SearchPage.errormsg2 = FFD.LocateById(SearchPage.errormsg2id);
	   }catch(Exception e) {
			Reporter.log("Can't find the error message");
			AssertJUnit.assertTrue(false);
		}
  ...
  //a[@class='name']
    try {
    	SearchPage.user1 = FFD.LocateByXpath("//a[@class='name']");
   }catch(Exception e) {
		Reporter.log("Can't find the User");
		Assert.assertTrue(false);
	}
